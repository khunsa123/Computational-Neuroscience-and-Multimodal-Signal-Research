...
| ------------------ | -------------- |
| Mean               | 0.058 s        |
| Standard Deviation | 0.0548 s       |
| Range              | 0.0007–0.579 s |

The latency distribution is positively skewed, consistent with the variability commonly observed in reaction-time measurements.
...
| Comparison        | p-value |
| ----------------- | ------- |
| sub-01 vs. sub-23 | 0.8246  |

No statistically significant difference was observed between these two participants.
...
The ANOVA indicates significant differences in saccade latency across the participant cohort.
