...
| ------------ | ------------------------------------ |
| EEG          | Theta power, Alpha power, Beta power |
| Eye Tracking | Blink rate                           |
| GSR          | Tonic level, Phasic peak count       |
| PPG          | Heart rate, HRV (RMSSD)              |
...
The results indicate that neural activity provides the strongest predictive signal, while autonomic physiological measures contribute complementary information.
